...
from AzureFunctionsTestWorkaround.ACTIVE.active_ccd.ccdFunctions import start_case_creation, validate_case, submit_case, process_case
from AzureFunctionsTestWorkaround.ACTIVE.active_ccd.tokenManager import IDAMTokenManager, S2S_Manager
...
@patch("AzureFunctionsTestWorkaround.ACTIVE.active_ccd.ccdFunctions.submit_case")
@patch("AzureFunctionsTestWorkaround.ACTIVE.active_ccd.ccdFunctions.validate_case")
@patch("AzureFunctionsTestWorkaround.ACTIVE.active_ccd.ccdFunctions.start_case_creation")
