...
# -------------------------------
# 2️⃣ Load country lookup fixture
# -------------------------------
@pytest.fixture(scope="session")
def bronze_countryFromAddress(spark):
    # Adjust the path if running locally vs Databricks
    csv_path = "../../../ReferenceData/countries_countryFromAddress.csv"

    if not os.path.exists(csv_path):
        # fallback for demo/testing if CSV missing
...
# def test_fixture_works(legalRepDetails_outputs):
#     assert "Case01" in legalRepDetails_outputs
