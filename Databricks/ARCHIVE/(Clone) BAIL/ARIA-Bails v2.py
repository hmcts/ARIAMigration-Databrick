...
import dlt
import json
from pyspark.sql.functions import when, col,coalesce, current_timestamp, lit, date_format,desc, first,concat_ws,count
...
# filter m1 for the test case no
m1 = spark.read.table("hive_metastore.aria_bails.bronze_bail_ac_cr_cs_ca_fl_cres_mr_res_lang").filter(col("CaseNo").isin(test_case_no)).alias("m1")
m2 = spark.read.table("hive_metastore.aria_bails.bronze_bail_ac_ca_apt_country_detc").filter(F.col("Relationship").isNull()).filter(F.col("CaseNo").isin(test_case_no)).alias("m2")
m1_m2 = m1.join(
    m2,F.col("m1.CaseNo") == col("m2.CaseNo")
)
...
# Hearing details mapping 
historydetail_replacements = {
...
### HTML TEMPLATE CODE FOR FINANCIAL CONDITION
...
### HTML TEMPLATE CODE FOR STATIS/HEARING DETAILS

hearing_status_code = """<div id="hearingDetails">
                                <br>
                                <br>
                                <table id="table7">
                                    <tbody><tr>
                                        <th style="vertical-align: top; text-align: left; padding-left:5px">Hearing Details</th>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <table id="table7">
                                                <tbody><tr>
                                                    <th colspan="6" style="vertical-align: top; text-align: left; padding-left:5px">Hearing Details</th>
                                                </tr>
                                                <tr>
                                                    <td id="labels"><label for="hearingCentre">Hearing Centre : </label></td>
                                                    <td><input type="text" id="hearingCentre"  value="{{HearingCentre}}"></td>
                                                    <td id="labels"><label for="court">Court : </label></td>
                                                    <td><input type="text" id="court" value="{{Court}}" readonly></td>
                                                    <td id="labels"><label for="hearingDate">Hearing Date : </label></td>
                                                    <td><input type="text" id="hearingDate" value="{{HearingDate}}" readonly></td>
                                                </tr>
                                                <tr>
                                                    <td id="labels"><label for="listName">List name : </label></td>
                                                    <td><input type="text" id="listName" value="{{ListName}}" readonly></td>
                                                    <td id="labels"><label for="listType">List type : </label></td>
                                                    <td><input type="text" id="listType" value="{{ListType}}" readonly></td>
                                                    <td id="labels"><label for="hearingType">Hearing Type : </label></td>
                                                    <td><input type="text" id="hearingType" value="{{HearingType}}" readonly></td>
                                                </tr>
                                                <tr>
                                                    <td id="labels"><label for="listStartTime">List start time : </label></td>
                                                    <td><input type="text" id="listStartTime" value="{{ListStartTime}}" readonly></td>
                                                </tr>
                                            </tbody></table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <table id="table7">
                                                <tbody><tr>
                                                    <th colspan="6" style="vertical-align: top; text-align: left; padding-left:5px">Assigned judicial officers</th>
                                                </tr>
                                                <tr>
                                                    <td id="labels" style="width:20%"><label for="judgeFT">Judge First-tier : </label></td>
                                                    <td><input type="text" id="judgeFT" value="{{JudgeFT}}" readonly></td>
                                                </tr>
                                                <tr>
                                                    <td id="labels"><label for="courtClerkUsher">Court clerk/Usher : </label></td>
                                                    <td><input type="text" id="courtClerkUsher" value="{{CourtClerkUsher}}" readonly></td>
                                                </tr>
                                            </tbody></table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <!-- left side -->
                                        <td>
                                            <table id="table3" style="height: 210px;">
                                                <tbody><tr>
                                                    <th style="vertical-align: top; text-align: left; padding-left:5px">File Details</th>
                                                </tr>
                                                <tr>
                                                    <td id="labels"><label for="startTime">Start time : </label></td>
                                                    <td><input type="time" id="startTime" value="{{StartTime}}" readonly></td>
                                                </tr>
                                                <tr>
                                                    <td id="labels"><label for="estDuration">Estimated duration : </label></td>
                                                    <td><input type="time" id="estDuration" value="{{EstDuration}}" readonly></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2" style="vertical-align: top; text-align: left; padding-left:5px">Required/Incompatible judicial officers</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <table id="table11">
                                                            <tbody><tr>
                                                                <th style="vertical-align: top; text-align: left; padding-left:5px">Judical Officers</th>
                                                                <th style="vertical-align: top; text-align: left; padding-left:5px">Req</th>
                                                            </tr>
                                        ...
                                        <!-- right side -->
                                        <td style="vertical-align: top;">
                                            <table id="table3" style="height:235px;">
                                                <tbody><tr>
                                                    <th style="padding:10px"></th>
                                                </tr>
                                                <tr>
                                                    <td id="labels"><label for="outcome">Outcome : </label></td>
                                                    <td><input type="text" id="outcome" value="{{outcome}}" readonly></td>
                                                </tr>
                                                <tr>
                                                    <td style="vertical-align: top;" id="labels"><label for="notes">Notes : </label></td>
                                                    <td style="vertical-align: top;"><textarea id="outcome" cols="45" rows="11"  readonly></textarea></td>
                                                </tr>
                                            </tbody></table>
                                        </td>
                                    </tr>
...
for row in m1_m2.collect():
   ...
   # initialise html template
    ...
    adj_statusId = m7_test.filter(F.col("CaseNo") == case_number).agg(F.first(F.col("AdjournmentParentStatusId"), True).alias("AdjournmentParentStatusId")).first()["AdjournmentParentStatusId"]

    adjourment_detail = m7_test.filter(F.col("StatusId")==value_row)
...
# MAGIC %md
# MAGIC
# MAGIC ## **DEV: Status/Hearing details dev
...
for outer_row in m1_m2.collect():
    case_number = outer_row["CaseNo"]
    html = html_template

    # Filter m3 for the current case_number
    m3_filtered = m3.filter(F.col("CaseNo") == case_number)
...
from pyspark.sql.functions import first,concat_ws
...
test_group = m3.groupBy(grouped_cols).agg(
    F.concat_ws(" ",
    first(when(col("Chairman") == True, col("AdjudicatorTitle"))),
     first(when(col("Chairman") == True, col("AdjudicatorForenames"))),
     first(when(col("Chairman") == True, col("AdjudicatorSurname")))).alias("JudgeFT"),
...
# judicial_officer_table = spark.read.table()

# COMMAND ----------

judicial_requirement = spark.read.table("hive_metastore.aria_bails.judicial_requirement")
display(judicial_requirement)
...
m7_test = spark.read.table("hive_metastore.aria_bails.bronze_bail_status_sc_ra_cs")
case_no_test = "AA/00002/2012"
display(m7_test)


# COMMAND ----------

value_row = m7_test.filter(F.col("CaseNo") == case_no_test).agg(F.first(F.col("AdjournmentParentStatusId"), True).alias("AdjournmentParentStatusId")).first()["AdjournmentParentStatusId"]
display(value_row)
