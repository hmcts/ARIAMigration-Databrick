from pyspark.sql.functions import (
    array, array_compact, array_contains, array_distinct, broadcast, col, collect_list, expr, lit, row_number, struct, when
)
...
def hearingRequirements(silver_m1, silver_m3, silver_c, bronze_interpreter_languages):
    ...
    interpreter_languages_lookup = (
        silver_m1.alias("m1")
            ...
            .withColumn("lu_spokenManualEntry",
                when((array_contains(col("lu_appellantInterpreterLanguageCategory"), spokenLanguageCategory)),
                    array_distinct(array_compact(array(
                        when((col("ail.appellantInterpreterLanguageCategory") == spokenLanguageCategory) & (col("il.manualEntry") == "Yes"),
                            col("il.manualEntry")
                        ),
                        when((col("ail.appellantInterpreterLanguageCategory") == spokenLanguageCategory) & (col("ail.manualEntry") == "Yes"),
                            col("ail.manualEntry")
    ...
    df_hearingRequirements = (
        silver_m1.alias("m1")
            ...
            .withColumn("appellantInterpreterSpokenLanguage", struct(col("ilu.lu_appellantInterpreterSpokenLanguage").alias("appellantInterpreterSpokenLanguage")))
            .withColumn("appellantInterpreterSignLanguage", struct(col("ilu.lu_appellantInterpreterSignLanguage").alias("appellantInterpreterSignLanguage")))
    ...
    df_audit_hearingRequirements = (
        df_hearingRequirements.alias("hr")
            ...
            .select(
                ...
                col("hr.isAppellantAttendingTheHearing"),
                ...
                col("hr.isAppellantGivingOralEvidence"),
                ...
                col("hr.isEvidenceFromOutsideUkOoc"),
                ...
                col("hr.isEvidenceFromOutsideUkInCountry"),
                ...
                col("hr.isInterpreterServicesNeeded"),
                ...
                col("hr.appellantInterpreterLanguageCategory"),
                ...
                col("hr.appellantInterpreterSpokenLanguage"),
                ...
                col("hr.appellantInterpreterSignLanguage"),
                ...
                col("hr.remoteVideoCallDescription"),
                ...
                col("hr.physicalOrMentalHealthIssues"),
                ...
                col("hr.pastExperiencesDescription"),
                ...
                col("hr.multimediaEvidenceDescription"),
                ...
                col("hr.singleSexCourtTypeDescription"),
                ...
                col("hr.inCameraCourtDescription"),
                ...
                col("hr.additionalRequestsDescription"),
