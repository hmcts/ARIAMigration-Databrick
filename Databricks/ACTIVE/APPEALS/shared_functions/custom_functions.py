...
def read_latest_parquet(
    ...
    view_name: str,
    process_name: str,
    base_path: str = "/mnt/ingest00landingsboxlanding/",
) -> "DataFrame":
    """
    ...
    # Add audit columns
    df = (
        df.withColumn("AdtclmnFirstCreatedDatetime", current_timestamp())
    ...
    print(
        f"Loaded the latest file for {folder_name} into view {view_name} with audit columns"
    )
