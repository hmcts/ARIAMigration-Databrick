    ...
    def get_checks_ended(self, checks={}):
        ...
        checks["valid_endAppealOutcomeReason"] = """(
            CASE
                ...
                ELSE
                    endAppealOutcomeReason IS NULL
            END
        )"""
