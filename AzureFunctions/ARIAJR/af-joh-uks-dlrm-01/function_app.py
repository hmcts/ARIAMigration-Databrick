...
@app.event_hub_message_trigger(
    arg_name="azeventhub",
    event_hub_name="evh-joh-pub-dev-uks-dlrm-01",
...
async def eventhub_trigger_appeals(azeventhub: List[func.EventHubEvent]):
    ...
    try:
        ...
        ev_dl_key = kv_client.get_secret("evh-joh-dl-dev-uks-dlrm-01-key").value
        ev_ack_key = kv_client.get_secret("evh-joh-ack-dev-uks-dlrm-01-key").value
        ...
        async with ContainerClient.from_container_url(container_url) as container_service_client, \
            ...
            tasks = [
                process_messages(event, container_service_client, "ARIAB/submission", dl_producer_client, ack_producer_client)
