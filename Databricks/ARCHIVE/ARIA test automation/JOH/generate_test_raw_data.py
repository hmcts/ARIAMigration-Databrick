...
def generate_adjudicator_data(num_records: int) -> pd.DataFrame:
    ...
    for _ in range(num_records):
        ...
        identity_number = "".join(str(fake.random_number(1) for _ in range(9)))
...
num_adjudicator_records: int = 1000
num_adjudicator_role_records: int = 1000
num_employment_term_records: int = 200
num_do_not_use_reason_records: int = 100
num_jo_history_records: int = 2000
num_users_records: int = 500
num_hearing_centre_records: int = 300
num_other_centre_records: int = 1000
