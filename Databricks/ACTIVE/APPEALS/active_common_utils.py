...
def caseData(silver_m1, silver_m3):
    ...
    df_audit = silver_m1.alias("audit").join(df.alias("content"), ["CaseNo"],"left") \
        ...
        lit("yes").alias("ariaDesiredState_Transformation"),
        ...
        lit("yes").alias("ariaMigrationTaskDueDays_Transformation")
    )
...
def flagsLabels(silver_m1, silver_m2, silver_c):
    ...
    df_audit = silver_m1.alias("audit").join(df.alias("content"), ["CaseNo"], "left") \
                        .join(silver_m2.alias("m2"), ["CaseNo"], "left").select(
        col("CaseNo"),

        #Audit caseFlags
        array(struct(*common_inputFields, lit("CategoryIds"), lit("HORef"))).alias("caseFlags_inputFields"),
        array(struct(*common_inputValues, col("content.CategoryIds"), col("audit.HORef"))).alias("caseFlags_inputValues"),
        ...
        array(struct(*common_inputValues, col("content.CategoryIds"), col("m2.Detained"))).alias("appellantLevelFlags_inputValues"),
...
def sponsorDetails(silver_m1, silver_c):
    ...
    df_audit = silver_m1.alias("audit").join(df.alias("content"), ["CaseNo"], "left").select(
        ...
        #audit hasSponsor
        array(struct(*common_inputFields, lit("audit.Sponsor_Name"), lit("content.CategoryId"))).alias("hasSponsor_inputFields"),
        array(struct(*common_inputValues, col("audit.Sponsor_Name"), col("content.CategoryId"))).alias("hasSponsor_inputValues"),
        col("content.hasSponsor"),
        lit("yes").alias("hasSponsor_Transformation"),

        #audit sponsorGivenNames
        array(struct(*common_inputFields, lit("audit.Sponsor_Forenames"), lit("content.CategoryId"))).alias("sponsorGivenName_inputFields"),
        array(struct(*common_inputValues, col("audit.Sponsor_Forenames"), col("content.CategoryId"))).alias("sponsorGivenName_inputValues"),
        col("content.sponsorGivenNames"),
        lit("yes").alias("sponsorGivenNames_Transformation"),

        #audit sponsorFamilyName
        array(struct(*common_inputFields, lit("audit.Sponsor_Name"), lit("content.CategoryId"))).alias("sponsorFamilyName_inputFields"),
        array(struct(*common_inputValues, col("audit.Sponsor_Name"), col("content.CategoryId"))).alias("sponsorFamilyName_inputValues"),
        col("content.sponsorFamilyName"),
        lit("yes").alias("sponsorFamilyName_Transformation"),

        #audit sponsorAddress
        array(struct(*common_inputFields, lit("audit.Sponsor_Address1"), lit("audit.Sponsor_Address2"), lit("audit.Sponsor_Address3"), lit("audit.Sponsor_Address4"), lit("audit.Sponsor_Address5"), lit("audit.Sponsor_Postcode"), lit("content.CategoryId"))).alias("sponsorAddress.inputFields"),
        array(struct(*common_inputValues, col("audit.Sponsor_Address1"), col("audit.Sponsor_Address2"), col("audit.Sponsor_Address3"), col("audit.Sponsor_Address4"), col("audit.Sponsor_Address5"), col("audit.Sponsor_Postcode"), col("content.CategoryId"))).alias("sponsorAddress.inputValues"),
        col("content.sponsorAddress"),
        lit("yes").alias("sponsorAddress_Transformation"),

        #audit sponsorAuthorisation
        array(struct(*common_inputFields, lit("audit.Sponsor_Authorisation"), lit("content.CategoryId"))).alias("sponsorAuthorisation_inputFields"),
        array(struct(*common_inputValues, col("audit.Sponsor_Authorisation"), col("content.CategoryId"))).alias("sponsorAuthorisation_inputValues"),
        col("content.sponsorAuthorisation"),
        lit("yes").alias("sponsorAuthorisation_Transformation"),

        #audit sponsorEmailAdminJ
        array(struct(*common_inputFields, lit("audit.Sponsor_Email"), lit("content.CategoryId"))).alias("sponsorEmailAdminJ_inputFields"),
        array(struct(*common_inputValues, col("audit.Sponsor_Email"), col("content.CategoryId"))).alias("sponsorEmailAdminJ.inputValues"),
        col("content.sponsorEmailAdminJ"),
        lit("yes").alias("sponsorEmailAdminJ_Transformation"),

        #audit sponsorMobileNumberAdminJ
        array(struct(*common_inputFields, lit("audit.Sponsor_Telephone"), lit("content.CategoryId"))).alias("sponsorMobileNumberAdminJ_inputFields"),
        array(struct(*common_inputValues, col("audit.Sponsor_Telephone"), col("content.CategoryId"))).alias("sponsorMobileNumberAdminJ.inputValues"),
