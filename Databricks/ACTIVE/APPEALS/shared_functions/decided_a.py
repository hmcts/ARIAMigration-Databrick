...
def documents(silver_m1): 
    ...
    documents_audit = (
        documents_audit.alias("audit")
            ...
            .select(
                "audit.*",
                array(struct(*common_inputFields)).alias("finalDecisionAndReasonsDocuments_inputFields"),
                array(struct(*common_inputValues)).alias("finalDecisionAndReasonsDocuments_inputValues"),
                col("documents.finalDecisionAndReasonsDocuments").alias("finalDecisionAndReasonsDocuments_value"),
