...
def mock_token_managers():
    with patch("AzureFunctions.Active.active_ccd.processCase.tokenManager.IDAMTokenManager") as mock_idam, \
         patch("AzureFunctions.Active.active_ccd.processCase.tokenManager.S2S_Manager") as mock_s2s:
