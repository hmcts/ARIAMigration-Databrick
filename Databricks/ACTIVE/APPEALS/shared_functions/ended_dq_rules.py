def add_checks(checks={}):
    ...
    checks = add_checks_hearingDetails(checks)
    checks = add_checks_ftpa(checks)
    checks = add_checks_hearingActuals(checks)
    checks = add_checks_substantiveDecision(checks)
    checks = add_checks_hearingResponse(checks)
    checks = add_checks_hearingRequirements(checks)
...
def add_checks_document(checks=None):
...
def add_checks_hearingDetails(checks=None):
...
def add_checks_hearingActuals(checks={}):
...
def add_checks_substantiveDecision(checks={}):
...
def add_checks_hearingResponse(checks={}):
...
def add_checks_hearingRequirements(checks={}):
...
def add_checks_general(checks=None):
