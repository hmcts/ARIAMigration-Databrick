...
from AzureFunctions.ACTIVE.active_ccd.retry_decorator import retry_on_result

SLEEP_PATH = "AzureFunctions.ACTIVE.active_ccd.retry_decorator.asyncio.sleep"
TO_THREAD_PATH = "AzureFunctions.ACTIVE.active_ccd.retry_decorator.asyncio.to_thread"
